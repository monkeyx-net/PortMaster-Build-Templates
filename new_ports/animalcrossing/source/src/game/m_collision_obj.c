...
int ClObj_dt(GAME* _p0, ClObj_c* _p1) {
    return 1;
}

int ClObj_set4(GAME* _p0, ClObj_c* cl, ACTOR* actor, ClObjData_c* data) {
...
void ClObj_OCClear(GAME* _p0, ClObj_c* cl) {
...
void ClObjElem_OCClear(GAME* _p0, ClObjElem_c* elem) {
...
int ClObjPipeAttr_dt(GAME* _p0, ClObjPipeAttr_c* _p1) {
    return 1;
}
