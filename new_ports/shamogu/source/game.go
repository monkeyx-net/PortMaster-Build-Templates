...
const FirstMapID ID = InventorySize
...
// all the information about map entities, as well as other relevant
// informations, including statistics.
type Game struct {
...
// WarningPrompt enters critical confirmation prompt mode.
func (g *Game) WarningPrompt() {
