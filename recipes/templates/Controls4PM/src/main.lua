...
local function showHelp()
    ...
    print("       love . create -c CONFIG_FILE -i INPUT_SVG -r README_FILE")
    print()
    print("Arguments:")
    ...
    print("  -c, --config      Config file to read key-value pairs")
    print("  -i, --input       Input SVG file to modify")
    print("  -r, --readme      README.md file to parse button mappings")
    print()
