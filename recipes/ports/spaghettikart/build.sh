...
cmake .. -GNinja \
  ...
  -DCMAKE_C_FLAGS="-fno-strict-aliasing -funsigned-char -fuse-ld=lld -Dma_uint64=uint64_t" \
  -DCMAKE_CXX_FLAGS="-fno-strict-aliasing -funsigned-char -fuse-ld=lld -Dma_uint64=uint64_t" \
