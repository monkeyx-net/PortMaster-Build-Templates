...
jq -n \
  ...
  '{
    ...
    name: $port_name,
    port_json: ("new_ports/" + $port_folder + "/" + $port_folder + "/" + $port_folder + "/port.json"),
    source: {
...
update_port_json() {
    ...
    jq --arg port_title "$port_title" \
       ...
       '.name = $port_folder + ".zip" |
        ...
        .attr.porter[0] = $porter_name' new_ports/${port_folder}/${port_folder}/${port_folder}/port.json > new_ports/${port_folder}/${port_folder}/${port_folder}/port.tmp
        mv new_ports/${port_folder}/${port_folder}/${port_folder}/port.tmp new_ports/${port_folder}/${port_folder}/${port_folder}/port.json
}
